...
import { getAllScheduledNotifications } from './notificationActions';
import { registerForPushNotificationsAsync } from './registerForPushNotificationsAsync';

// TODO: move to platform or move to screens/affirmations.tsx
...
export const useInitNotifications: Init = (providerActions, providerState) => {
  useEffect(() => {
    ...
    getAllScheduledNotifications().then((notifications: NotificationWithData[]) => {
